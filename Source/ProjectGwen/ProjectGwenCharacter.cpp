...
AProjectGwenCharacter::AProjectGwenCharacter()
{
...
void AProjectGwenCharacter::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	PlayerInputComponent->BindAxis("MoveForward", this, &AProjectGwenCharacter::MoveForward);
	PlayerInputComponent->BindAxis("MoveRight", this, &AProjectGwenCharacter::MoveRight);
	...
	PlayerInputComponent->BindTouch(IE_Released, this, &AProjectGwenCharacter::TouchStopped);
...
void AProjectGwenCharacter::TouchStarted(ETouchIndex::Type FingerIndex, FVector Location)
{
		Jump();
}

void AProjectGwenCharacter::TouchStopped(ETouchIndex::Type FingerIndex, FVector Location)
{
		StopJumping();
}
